...
public class AdicionarLinkEndereco implements AdicionadorLink<Endereco> {
    ...
    public void adicionarLink(List<Endereco> lista) {
        ...
        for (Endereco endereco : lista) {
            ...
            Link linkProprio = WebMvcLinkBuilder.linkTo(
                    WebMvcLinkBuilder.methodOn(EnderecoController.class).obterEndereco(id)).withSelfRel();
    ...
    public void adicionarLink(Endereco objeto) {
        ...
        Link linkProprio = WebMvcLinkBuilder.linkTo(
                WebMvcLinkBuilder.methodOn(EnderecoController.class).obterEndereco()).withRel("enderecos");
