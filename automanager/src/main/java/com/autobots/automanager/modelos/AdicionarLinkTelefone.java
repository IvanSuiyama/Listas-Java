...
public class AdicionarLinkTelefone implements AdicionadorLink<Telefone> {
    ...
    public void adicionarLink(List<Telefone> lista) {
        ...
        for (Telefone telefone : lista) {
            ...
            Link linkProprio = WebMvcLinkBuilder.linkTo(
                    WebMvcLinkBuilder.methodOn(TelefoneController.class).obterTelefone(id)).withSelfRel();
    ...
    public void adicionarLink(Telefone objeto) {
        ...
        Link linkProprio = WebMvcLinkBuilder.linkTo(
                WebMvcLinkBuilder.methodOn(TelefoneController.class).obterTelefone()).withRel("telefones");
